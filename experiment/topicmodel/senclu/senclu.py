...
class SenClu():
    ...
    def fit_transform(self, train_docs, test_docs, nTopics=50, alpha=None, nEpochs=40, loadAndStoreInFolder=None, verbose=True):
        """
        ...
        train_ptd = self.ptd.transpose()[:train_index]
        test_ptd = self.ptd.transpose()[train_index:]
        return train_ptd, test_ptd
