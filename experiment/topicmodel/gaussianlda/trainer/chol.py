...
from gaussianlda.src.utils import get_logger, get_progress_bar, chol_rank1_downdate, chol_rank1_update
from gaussianlda.src.perplexity import calculate_avg_ll


class GaussianLDATrainer:
    def __init__(self, corpus, vocab_embeddings, vocab, num_tables, alpha, log=None, save_path=None,
                 show_topics=None, cholesky_decomp=True, num_words_for_formatting=None):
        """
